...
HD_PWD='/nfs/home/p/p_thibe/COEN313/Modelsim/Code/lab4/Lab_4.1/Lab_4.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log registers_min_max.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source registers_min_max.tcl
