...
HD_PWD='/nfs/home/p/p_thibe/COEN313/Modelsim/Code/lab4/Lab_4.1/Lab_4.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log registers_min_max.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source registers_min_max.tcl -notrace
