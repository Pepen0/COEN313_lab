...
HD_PWD='/nfs/home/p/p_thibe/COEN313/Modelsim/Code/labQuizz/LabQuizz1.0/LabQuizz1.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_normalizer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_normalizer.tcl -notrace
