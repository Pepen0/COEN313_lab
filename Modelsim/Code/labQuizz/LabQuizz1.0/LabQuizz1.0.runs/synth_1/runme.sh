...
HD_PWD='/nfs/home/p/p_thibe/COEN313/Modelsim/Code/labQuizz/LabQuizz1.0/LabQuizz1.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_normalizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg_normalizer.tcl
