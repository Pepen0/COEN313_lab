...
HD_PWD='/nfs/home/p/p_thibe/COEN313/Modelsim/Code/lab2/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log minterms.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source minterms.tcl -notrace
