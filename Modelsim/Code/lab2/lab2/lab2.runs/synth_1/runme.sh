...
HD_PWD='/nfs/home/p/p_thibe/COEN313/Modelsim/Code/lab2/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minterms.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minterms.tcl
